...
let instsel_inst _ cc_info inst ~is_x64 =
  ...
  | Iinst_def (r1, expr) -> (
      ...
      | Iexpr_cast (castop, t, v) -> insert_cast insts r1 castop t v ~is_x64
      | Iexpr_call (fname, args) ->
