...
let mk_loadfield ib t addr field_index =
  mk_inst ib (Iinst_loadfield (t, addr, field_index))

let mk_storefield ib t addr field_index value =
  ignore (mk_inst ib (Iinst_storefield (t, addr, field_index, Iop_reg value)))
